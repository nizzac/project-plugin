<?php namespace Nizzac\Project\Controllers;

use BackendMenu;
use Backend\Classes\Controller;
use Backend\Facades\BackendAuth;
use Response;
use Nizzac\Project\Classes\ProjectApi;
...
class Project extends Controller
{
     ...
     */
    public $requiredPermissions = ['nizzac.project.project'];
    ...
    {
        parent::__construct();
        BackendMenu::setContext('Nizzac.Project', 'project', 'project');
    }
